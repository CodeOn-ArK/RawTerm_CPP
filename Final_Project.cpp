...
ITEM* my_item[] = {
			new_item("Colour Scheme"," "),
			new_item("Device"," "),
			new_item("Time Stamp"," "),
			new_item("Generate log"," "),
			new_item("Clear Screen"," "),
			new_item("Baud Rate"," "),
			new_item("Send Newline"," "),
			new_item("EXIT Console"," "),
			new_item("EXIT MENU"," "),
			NULL
                  };
ITEM* my_item1[] = {
...
int main(){
	int i,c;				
	ITEM *cur_item;
	WINDOW *my_menu_win,*my_menu_win1,*my_menu_win2,*my_menu_win3,*my_menu_win4,*my_menu_win5,*my_menu_win6;
